...
var Auth0Provider = function (opts) {
    ...
    var client = useState(function () { return providedClient !== null && providedClient !== void 0 ? providedClient : new ju(toAuth0ClientOptions(clientOpts)); })[0];
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    if (response_type === at.ConnectCode) {
    ...
    var revokeRefreshToken = useCallback(function (opts) { return __awaiter(void 0, void 0, void 0, function () {
        var _a;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
...
var useEnterpriseConnect = function (context) {
    if (context === void 0) { context = Auth0Context; }
    var _a = useContext(context), getConfiguration = _a.getConfiguration, loginWithRedirect = _a.loginWithRedirect;
    var isFederatedDomain = useCallback(
    ...
    var loginWithSSO = useCallback(function (email, options) {
...
export { Auth0Context, Auth0Provider, R as AuthenticationError, A as ConnectError, E as GenericError, De as InMemoryCache, C as InvalidConfigurationError, Je as LocalStorageCache, gu as MfaChallengeError, wu as MfaEnrollmentError, bu as MfaEnrollmentFactorsError, mu as MfaError, yu as MfaListAuthenticatorsError, W as MfaRequiredError, vu as MfaVerifyError, N as MissingRefreshTokenError, K as MissingScopesError, Ct as MyAccountApiError, OAuthError, hc as PasskeyChallengeError, Su as PasskeyError, pc as PasskeyGetTokenError, dc as PasskeyRegisterError, O as PopupCancelledError, j as PopupOpenError, I as PopupTimeoutError, st as RefreshTokenMode, at as ResponseType, x as TimeoutError, M as UseDpopNonceError, ct as User, initialContext, useAuth0, useAuth0Suspense, useEnterpriseConnect, withAuth0, withAuthenticationRequired };
