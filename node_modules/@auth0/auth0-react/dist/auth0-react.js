(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var Auth0Provider = function (opts) {
        ...
        var client = React.useState(function () { return providedClient !== null && providedClient !== void 0 ? providedClient : new ju(toAuth0ClientOptions(clientOpts)); })[0];
        ...
        var _e = React.useState(createInitDeferred), initDeferred = _e[0], setInitDeferred = _e[1];
        ...
        var _f = React.useState(false), initFailed = _f[0], setInitFailed = _f[1];
        ...
        var initRetried = React.useRef(false);
        ...
        var runInit = React.useCallback(function (deferred, allowRedirect) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        var revokeRefreshToken = React.useCallback(function (opts) { return __awaiter(void 0, void 0, void 0, function () {
            var _a;
            var _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, , 2, 4]);
                        return [4 /*yield*/, client.revokeRefreshToken(opts)];
                    case 1:
                        _c.sent();
                        return [3 /*break*/, 4];
                    case 2:
     ...
     */
    var useEnterpriseConnect = function (context) {
        if (context === void 0) { context = Auth0Context; }
        var _a = React.useContext(context), getConfiguration = _a.getConfiguration, loginWithRedirect = _a.loginWithRedirect;
        var isFederatedDomain = React.useCallback(
        // domain is read at call time, not when the callback is memoized
        function (emailDomain, options) {
            return Wu(getConfiguration().domain, emailDomain, options);
        }, [getConfiguration]);
        var loginWithSSO = React.useCallback(function (email, options) {
            return loginWithRedirect(__assign(__assign({}, options), { authorizationParams: __assign(__assign({}, options === null || options === void 0 ? void 0 : options.authorizationParams), { login_hint: email }) }));
        }, [loginWithRedirect]);
        return { isFederatedDomain: isFederatedDomain, loginWithSSO: loginWithSSO };
    };
    ...
    */
    ...
    exports.AuthenticationError = R;
    exports.ConnectError = A;
    exports.GenericError = E;
    exports.InMemoryCache = De;
    exports.InvalidConfigurationError = C;
    exports.LocalStorageCache = Je;
    exports.MfaChallengeError = gu;
    exports.MfaEnrollmentError = wu;
    exports.MfaEnrollmentFactorsError = bu;
    exports.MfaError = mu;
    exports.MfaListAuthenticatorsError = yu;
    exports.MfaRequiredError = W;
    exports.MfaVerifyError = vu;
    exports.MissingRefreshTokenError = N;
    exports.MissingScopesError = K;
    exports.MyAccountApiError = Ct;
    exports.OAuthError = OAuthError;
    exports.PasskeyChallengeError = hc;
    exports.PasskeyError = Su;
    exports.PasskeyGetTokenError = pc;
    exports.PasskeyRegisterError = dc;
    exports.PopupCancelledError = O;
    exports.PopupOpenError = j;
    exports.PopupTimeoutError = I;
    exports.RefreshTokenMode = st;
    exports.TimeoutError = x;
    exports.UseDpopNonceError = M;
    exports.User = ct;
    exports.initialContext = initialContext;
    exports.useAuth0 = useAuth0;
    exports.useAuth0Suspense = useAuth0Suspense;
    exports.useEnterpriseConnect = useEnterpriseConnect;
